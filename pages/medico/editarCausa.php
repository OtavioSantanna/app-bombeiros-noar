...
<body style="width: 100%; height: 100vh;">
    ...
    <form method="post" action="../../php/requests/editar_causa.php">
        ...
        echo("
            ...
            <div class='title_sq center'>
                ...
                <input type='text' name='nova_causa' class='input_edicao' placeholder='NOVO DADO...'>
                <input type='hidden' name='dado_antigo' value='$dado_antigo'>
